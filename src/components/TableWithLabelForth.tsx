                ...
                <Table celled unstackable>
                    ...
                    <Table.Body>
                        <Table.Row>
                            ...
                            <Table.Cell>{data[0] && data[0]['multiple']}</Table.Cell>
                        </Table.Row>
                        <Table.Row error>
                            <Table.Cell>{data[1] ? (data[1]['multiple'] == data[0]['multiple'] ? '１位' : '２位') : '２位'}</Table.Cell>
                            <Table.Cell>{data[1] && data[1]['name']}</Table.Cell>
                            <Table.Cell>{data[1] && data[1]['number_times']}</Table.Cell>
                            <Table.Cell>{data[1] && data[1]['multiple']}</Table.Cell>
                        </Table.Row>
                        <Table.Row>
                            <Table.Cell>{data[2] ? (data[2]['multiple'] == data[0]['multiple'] ? '１位' : (data[2]['multiple'] == data[1]['multiple'] ? '２位' : '３位')) : '３位'}</Table.Cell>
                            <Table.Cell>{data[2] && data[2]['name']}</Table.Cell>
                            <Table.Cell>{data[2] && data[2]['number_times']}</Table.Cell>
                            <Table.Cell>{data[2] && data[2]['multiple']}</Table.Cell>
                        </Table.Row>
                    </Table.Body>
                </Table>
            </div>
